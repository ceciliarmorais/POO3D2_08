<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_musica.aspx.cs" Inherits="POO3D2_08.UI.frm_musica" %>
    ...
    <form id="frm_grav" runat="server">
        <nav class="main-header navbar navbar-expand bg-secondary" runat="server">
            <ul class="navbar-nav">
                ...
                <li class="pl-2 nav-item d-none d-inline-block"><i class="fas fa-music"></i><span>Músicas</span></li>
            </ul>
        </nav>
        ...
        <div class="container" runat="server">
                ...
                <div class="form-group" runat="server">
                    <asp:Label runat="server" Text="Autor" AssociatedControlId="txt_nomeAutor"/>
                    <asp:TextBox ID="txt_nomeAutor" type="text" runat="server" CssClass="form-control" ></asp:TextBox>
                </div>
                <div class="form-group" runat="server">
                    <asp:Label runat="server" Text="Id Gravadora" AssociatedControlId="txt_idGravadora"/>
                    <asp:TextBox ID="txt_idGravadora" type="number" min="0" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="form-group" runat="server">
                    <asp:Label runat="server" Text="Id CD" AssociatedControlId="txt_idCD"/>
                    <asp:TextBox ID="txt_idCD" type="number" min="0" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
